/*
	Simplex algorithm to solver Linear Optimization problems

	Description: It maximizes f(x) = c * x subject to Ax <= b, x >= 0

	Complexity: in average O(n * m * pivots), worst acase O(2 ^ n)

	Credits: https://github.com/brunomaletta/Biblioteca/blob/master/Codigo/Matematica/simplex.cpp
*/
